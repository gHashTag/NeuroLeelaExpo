  ...
  return (
    <SafeAreaView className="flex-1 bg-background p-4" edges={["bottom"]}>
        ...
        {verifyEmail === "true" && (
          <View className="bg-yellow-500/20 p-4 rounded-lg">
            <Text className="text-yellow-500 font-medium">
              Пожалуйста, подтвердите ваш email адрес перед входом. Проверьте вашу почту и перейдите
              по ссылке для подтверждения.
            </Text>
            <Button
              size="sm"
              variant="ghost"
      ...
      <Button
        ...
        className="web:m-4"
      >
        {isLoading ? <ActivityIndicator size="small" color="white" /> : <Text>Войти</Text>}
      </Button>
    </SafeAreaView>
  );
}
